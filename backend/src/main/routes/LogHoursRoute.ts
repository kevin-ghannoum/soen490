...
export default class LogHoursRoute extends CommonRoutesConfig {
  ...
  configureRoutes(): express.Application {
    this.getApp()
      .route(`/logHours`)
      .post(checkJwt, checkRole(new Set([Roles.SUPERVISOR, Roles.BUSINESS])), async (req: express.Request, res: express.Response, next: express.NextFunction) => {
        try {
    ...
    this.getApp()
      ...
      .get(checkJwt, checkRole(new Set([Roles.SUPERVISOR, Roles.BUSINESS])), async (req: express.Request, res: express.Response, next: express.NextFunction) => {
        try {
